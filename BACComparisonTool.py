...
df1 = pd.read_excel('outputTest-1.xlsx', 'Sheet1', na_values=['NA'])
df2 = pd.read_excel('outputTest-2.xlsx', 'Sheet1', na_values=['NA'])
...
diff_output[(diff_output.has_change == 'Y')].to_excel('fruit-test.xlsx',index=False,columns=["Fruits", "Quantity"])